module.exports = [
  {
    _id: 'seed-guardians',
    title: 'Guardians of the Red Earth: Bimfalb Storytellers',
    ...
    body: `
      ...
      <p>Through drum patterns and call-and-response, history travelled across generations, reminding us that archives can also be sung.</p>
      <ul>
        <li>Lineage chants recorded on woven leather scrolls</li>
        <li>Evening fireside circles open to all ages</li>
        <li>Seasonal rituals that pair story with harvest</li>
      </ul>`,
  ...
  },
  {
    ...
    body: `
      ...
      <p>Artisans read the soil the way librarians read shelves - searching for the exact hue that tells a story.</p>`,
    videoUrl: '',
  ...
  {
    _id: 'seed-river-songs',
    title: 'When the River Carried Songs',
    ...
    body: `
      ...
      <p>Today, community choirs revive that route each solstice, turning waterways into living stages.</p>`,
  ...
  },
  {
    ...
    body: `
      ...
      <p>The glow honors ancestors and guides young ones through stories of becoming.</p>`,
    videoUrl: '',
