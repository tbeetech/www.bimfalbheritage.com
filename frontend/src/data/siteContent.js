...
export const faqItems = [
  {
    q: 'What is Bimfalb Heritage focused on?',
    a: 'Bimfalb Heritage preserves and promotes cultural heritage, supports artists, and develops awareness programs around cultural coexistence and identity.',
  },
  {
    q: 'How does Bimfalb support young musicians?',
    a: 'The initiative offers performance opportunities, collaboration channels, and visibility programs for young local creatives.',
  },
  {
    q: 'Can communities nominate cultural heritage sites?',
    a: 'Yes. Individuals and communities can submit nominations based on cultural significance and historical value.',
  },
  {
    q: 'How can I participate?',
    a: 'You can volunteer, donate, partner, nominate sites, or attend events and campaigns hosted by the organization.',
  },
];
